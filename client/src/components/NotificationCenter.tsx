...
import { Bell, FileText, PawPrint, User, Check, Info, AlertTriangle, CheckCircle, XCircle, Sparkles, ExternalLink, Clock } from 'lucide-react';
    ...
    <div className="relative" ref={dropdownRef}>
      ...
      >
        <Bell 
          ...
          style={{ color: isOpen ? 'var(--color-primary)' : 'var(--color-text-light)' }} 
        />
        <AnimatePresence>
          {unreadCount > 0 && (
            <motion.span 
            ...
            <div className="max-h-[420px] overflow-y-auto">
              {notifications.length > 0 ? (
                    ...
                    return (
                      ...
                      >
                        <Link 
                          ...
                          onClick={() => {
                            if (!notification.read) markRead(notification._id, {} as any);
                            setIsOpen(false);
                          }}
                        >
                          <div className="flex gap-3.5">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-start justify-between gap-2 mb-1">
                                <h4 
                                  className={`text-sm leading-snug ${!notification.read ? 'font-bold' : 'font-medium'}`}
                ...
                <div className="py-16 px-8 text-center">
                  ...
                  >
                    <Bell className="w-7 h-7" style={{ color: 'var(--color-text-light)', opacity: 0.4 }} />
                  </div>
