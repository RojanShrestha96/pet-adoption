            ...
            <div className="p-2">
              {themes.map(theme => (
                <button
                  ...
                  style={{
                    background: currentTheme === theme.name ? 'var(--color-surface)' : 'transparent',
                    border: currentTheme === theme.name ? '2px solid var(--color-primary)' : '2px solid transparent'
                  }}
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex gap-1">
                      <div className="w-6 h-6 rounded-lg" style={{ 
                        background: theme.name === 'lavender' ? '#B19CD9' : 
                                   theme.name === 'friendly' ? '#D4745C' : 
                                   theme.name === 'bold' ? '#6C5CE7' : '#6A4C93'
                      }} />
                      <div className="w-6 h-6 rounded-lg" style={{ 
                        background: theme.name === 'lavender' ? '#E6E6FA' : 
                                   theme.name === 'friendly' ? '#7C9885' : 
                                   theme.name === 'bold' ? '#FF6B9D' : '#FFD700'
                      }} />
                    </div>
