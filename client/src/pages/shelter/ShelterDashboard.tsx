    ...
    const fetchDashboardData = async () => {
      try {
        ...
        const analyticsResponse = await fetch(
          "http://localhost:5000/api/shelter/analytics",
          {
            headers: { Authorization: `Bearer ${token}` },
          }
        );
        if (analyticsResponse.ok) {
          ...
          // Update petStats from analytics
          setPetStats({
        ...
        const applicationsResponse = await fetch(
          "http://localhost:5000/api/applications/shelter?limit=6",
          {
            headers: { Authorization: `Bearer ${token}` },
          }
        );
          ...
          setApplications(
            data.applications.map((app: any) => ({
              ...
              applicantName:
                ...
                "Unknown Applicant",
              applicantEmail:
                app.personalInfo?.email || app.adopter?.email || "",
              status: app.status,
        ...
        <main className="flex-1 p-4 sm:p-6 overflow-y-auto">
          ...
          >
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  {shelterData?.isVerified ? (
                    <span className="bg-white/20 text-white border border-white/30 px-2 py-1 rounded-full text-xs font-medium flex items-center gap-1 whitespace-nowrap">
                ...
                {!shelterData?.isVerified && (
                  <p className="text-white/90 text-xs mt-2 bg-white/10 inline-block px-3 py-1 rounded-full">
                    Your shelter will appear publicly after admin verification
                  </p>
                )}
              </div>
            ...
            <div className="space-y-6">
              {/* Pet Distribution & Adoption Trends */}
              <div className="grid lg:grid-cols-2 gap-6">
                {/* Pet Distribution Pie Chart */}
                <Card className="p-5">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="font-bold text-gray-900">Pet Distribution</h3>
                    <Link
                ...
                <Card className="p-5">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="font-bold text-gray-900">Adoption Trends</h3>
