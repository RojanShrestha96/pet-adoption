...
export function SuccessStoriesPage() {
  ...
  const getPetTypeVariant = (type: string) => {
    switch (type.toLowerCase()) {
      ...
      case 'cat': return 'secondary';
      case 'rabbit': return 'success';
        ...
        <section className="relative py-16 md:py-24 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            >
              ...
              <p className="text-lg md:text-xl leading-relaxed" style={{ color: 'var(--color-text-light)' }}>
            ...
            >
              {successStories.map((story, index) => (
                <motion.div key={story.id} variants={itemVariants}>
                  <Card className={`overflow-hidden border border-[var(--color-border)] ${index % 2 === 0 ? '' : 'md:flex-row-reverse'}`}>
                    <div className={`flex flex-col ${index % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
                      ...
                      <div className="md:w-2/5 relative h-64 md:h-auto">
                        ...
                        <div className="absolute top-4 left-4">
                          <Badge variant={getPetTypeVariant(story.petType) as any}>
                      ...
                      {/* Content Section */}
                      <div className="md:w-3/5 p-6 md:p-8 flex flex-col" style={{ background: 'var(--color-card)' }}>
                        {/* Header */}
                        <div className="mb-4">
                          <div className="flex items-center gap-2 text-sm mb-2" style={{ color: 'var(--color-text-light)' }}>
                        ...
                        <div className="flex-1 relative">
                          <QuoteIcon className="w-8 h-8 absolute -top-2 -left-2 opacity-20" style={{ color: 'var(--color-primary)' }} />
                          <p className="leading-relaxed pl-6 italic" style={{ color: 'var(--color-text)' }}>
                            "{story.story}"
                          </p>
                        </div>

                        {/* Footer */}
                        <div className="mt-6 pt-4 border-t flex items-center justify-between" style={{ borderColor: 'var(--color-border)' }}>
                          ...
                          <HeartIcon className="w-6 h-6" style={{ color: 'var(--color-accent)' }} />
                        </div>
                      </div>
                    </div>
                  </Card>
              ...
              >
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
                        ...
                        Start your adoption journey today and become part of our
                        success stories.
                    </p>
