  ...
  const whyAdopt = [
    {
      icon: Heart,
      title: 'Save a Life',
      description: 'Give a homeless pet a second chance at happiness and unconditional love',
    },
    {
      icon: Home,
      title: 'Find Your Match',
      description: 'Discover the perfect companion that fits your lifestyle and personality',
    },
    {
      icon: Shield,
      title: 'Trusted Process',
      description: 'All pets are health-checked, vaccinated, and ready for their new home',
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                ...
                <span className="text-sm font-medium" style={{ color: 'var(--color-text)' }}>#1 Pet Adoption Platform</span>
              </motion.div>

              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight" style={{ color: 'var(--color-text)' }}>
                Give a Pet a <span style={{ color: 'var(--color-primary)' }}>Forever Home</span>
              </h1>

              <p className="text-lg md:text-xl mb-8" style={{ color: 'var(--color-text-light)' }}>
                Connect with loving pets waiting for adoption. Start your journey to finding a loyal companion today.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-6 mb-8">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="font-bold" style={{ color: 'var(--color-text)' }}>2,500+</div>
                    <div className="text-xs" style={{ color: 'var(--color-text-light)' }}>Pets Adopted</div>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-10 h-10 rounded-full flex items-center justify-center" style={{ background: 'var(--color-primary)' }}>
                  ...
                  <div>
                    <div className="font-bold" style={{ color: 'var(--color-text)' }}>5,000+</div>
                    <div className="text-xs" style={{ color: 'var(--color-text-light)' }}>Happy Families</div>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-10 h-10 rounded-full flex items-center justify-center" style={{ background: 'var(--color-primary)' }}>
                  ...
                  <div>
                    <div className="font-bold" style={{ color: 'var(--color-text)' }}>150+</div>
                    <div className="text-xs" style={{ color: 'var(--color-text-light)' }}>Shelters</div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-5">
                  ...
                  {quickFilters.map((filter, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="text-sm font-medium" style={{ color: 'var(--color-text)' }}>{filter.label}</span>
                      </motion.button>
                    );
                  })}
                </div>
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }} className="flex gap-4">
                  <Button variant="primary" size="lg" onClick={() => navigate('/search')} icon={<PawPrint className="w-5 h-5" />}>Browse Pets</Button>
                  {isLoggedIn ? (
                    <Button variant="outline" size="lg" onClick={() => navigate('/profile')} icon={<User className="w-5 h-5" />}>My Profile</Button>
                  ) : (
            ...
            >
              ...
              >
                <img 
                  src={featuredPets[0]?.images[0] || 'https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=600'} 
                  alt="Featured pet" 
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="text-2xl font-bold text-white mb-1">{featuredPets[0]?.name || 'Buddy'}</h3>
                      <p className="text-white/80">{featuredPets[0]?.breed || 'Waiting for a loving home'}</p>
                    </div>
                    <motion.button
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-bold" style={{ color: 'var(--color-text)' }}>98%</div>
                    <div className="text-xs" style={{ color: 'var(--color-text-light)' }}>Success Rate</div>
                  </div>
                </div>
              </motion.div>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p
              ...
              style={{ color: 'var(--color-text-light)' }}
            >
              These loving pets are waiting for their forever homes. Could you be their perfect match?
            </p>
          </motion.div>
      ...
      <section className="py-16" style={{ background: 'var(--color-surface)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {loadingShelters ? (
               <div className="col-span-full text-center py-10">Loading shelters...</div>
            ) : shelters.length > 0 ? (
               ...
               <div className="col-span-full text-center py-10 text-[var(--color-text-light)]">No shelters found nearby.</div>
            )}
          </div>
        </div>
      </section>
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
                Thousands of adorable pets are waiting for loving homes. Start your adoption journey today!
              </p>
